...
export const labSections: LabSection[] = [
  {
    ...
    entries: empty(3, (i) => ({ id: `physics-${i + 1}`, title: null, note: null, media: null })),
  },
  {
    id: "chemistry",
    name: "Chemistry",
    ...
    entries: empty(3, (i) => ({ id: `chemistry-${i + 1}`, title: null, note: null, media: null })),
  },
  {
    id: "biology",
    name: "Biology",
    ...
    entries: empty(3, (i) => ({ id: `biology-${i + 1}`, title: null, note: null, media: null })),
  },
  {
    id: "mathematics",
    name: "Mathematics",
    ...
    entries: empty(3, (i) => ({ id: `mathematics-${i + 1}`, title: null, note: null, media: null })),
  },
];
